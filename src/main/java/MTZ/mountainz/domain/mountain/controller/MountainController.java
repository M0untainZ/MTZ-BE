...
public class MountainController {
    ...
    // 산 등록
    @PostMapping("/add")
    public ResponseDto<?> createMountain(@RequestPart(required = false, value = "file") List<MultipartFile> multipartFile,
        ...
        return mountainService.createMountain(multipartFile, mountainRequestDto, userDetailsImpl.getMember().getEmail());
    }
}
